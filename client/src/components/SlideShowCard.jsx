...
const SlideShowCard = ({ images, index, prev, next }) => {
  return (
    <section className="py-30 bg-base-200">
      <h1 className="text-4xl md:text-5xl flex justify-center font-extrabold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
        Our Services
      </h1>
      <br />
        ...
        <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-8 shadow-xl">
          <div className="lg:flex lg:items-center lg:gap-8">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <h2 className="text-3xl md:text-4xl font-extrabold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
