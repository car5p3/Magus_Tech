...
import "./NavBar.css";
import magus from "../assets/magus.jpeg";
    ...
    <div className="w-full fixed top-6 left-0 z-30 flex justify-center pointer-events-none">
      <nav className="navbar-glass w-[min(1100px,96%)] pointer-events-auto px-4 py-3 flex items-center justify-between">
        <div className="nav-brand">
          <Link to="/" className="btn-ghost normal-case text-xl p-0 flex items-center gap-3">
            {/* <img
              src={magus}
              alt="Magus logo"
              className="h-18 w-auto rounded-md"
            /> */}
            <span className="logo-text text-brand-gradient">
              magus
            </span> 
          </Link>
        </div>
