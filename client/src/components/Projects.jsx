  ...
  return (
    <section id="projects" className="py-30 bg-base-200">
      <div className="container mx-auto px-6">
        <h3 className="text-3xl md:text-4xl text-center font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
          Projects
        </h3>
          ...
          {projects.map((p) => (
            <article key={p.id} className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="p-5 flex flex-col gap-3">
                <h4 className="text-lg font-semibold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">{p.title}</h4>
